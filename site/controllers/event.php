...
// 		$view 	= $this->input->get('view');
	...
	public function save($key = null, $urlVar = 'id')
	{
		...
		{
			// If not ok, redirect to the edit page with message.
	...
	protected function postSaveHook(JModelLegacy $model, $validData = array())
	{
		...
		if (
			( $params->get('frontend_approve', '0') ||
				$params->get('use_frontend_submission_email', '0') == '1' )
				&& $isNew == '1'
		)
		{
...
// 			$msg = JText::sprintf('COM_SIMPLECALENDAR_MAIL_ERROR_NOT_SENT %s', $sent->getError());
	...
	private static function _sendMail($user, $event)
	{
		...
		$subject = JText::_('COM_SIMPLECALENDAR_MAIL_NEW_EVENT_POSTED_ON') . ' ' . $sitename;
		...
		{    // only for logged-in users
			...
			/* 	Name
				...
				Site URL
				*/
			if ($params->get('frontend_approve', '0') == '1')
			{
