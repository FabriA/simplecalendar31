	...
	protected function getListQuery()
	{
		...
		switch ($period)
		{
			...
			case 'upcoming':
				...
				break;
			case 'ongoing':
				$query->where('a.start_dt <= CURDATE() AND a.end_dt >= CURDATE()');
				break;
			case 'all':
			default:
				break;
...
// 		Add the list ordering clause.
	...
	/**
	 * Exports all records found to CSV
	 * @param string $columns to export
	 * @param string $pk values
	 *
	 * @return mixed list of records
	 */
	function getItemsForExport($columns = '*', $pk='id')
	{
		$db    = $this->getDbo();
		$query = $db->getQuery(true);
